...
export const HotelCard = ({room, index}) => {
  return (
        ...
        className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(_0,0,0,0.5)]'>
            ...
            <div className='p-4 pt-5'>
                ...
                <div className='flex items-center justify-between mt-4'>
                    ...
                    rounded hover:bg-gray-50 transtion-all cursor-pointer'>Book Now </button>
                </div>
