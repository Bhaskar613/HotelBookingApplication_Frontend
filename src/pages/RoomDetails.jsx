        ...
        justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                <div className='flex flex-col'>
                    ...
                    className='w-full rounded border-gray-300 px-3 py-2 mt-1.5 outline-none' required />
                </div>
                <div className='w-px h-15 bg-gray-300/70 max:hidden'></div>
                <div className='flex flex-col'>
            ...
            transition-colors text-white font-semibold
             rounded-md px-8 py-3 mt-6 md:mt-0 shadow-md cursor-pointer'>
                Check Availability
            </button>
        </form>
