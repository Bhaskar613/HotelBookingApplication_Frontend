    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32 '>
        <div>
            <div className='flex flex-col items-start text-left'>
                ...
                <p className='text-sm md:text-base text-gray-500/90 mt-2'>Take advantage of our limited-time offers and special packages 
            ...
            {roomsDummyData.map((room)=>(
                <div className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                    ...
                    <div className='md:w-1/2 flex flex-col gap-2'>
                        ...
                        <p onClick={()=>{navigate(`/room/${room.id}`); scrollTo(0,0)}}
                        ...
                        <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                            {room.amenities.map((item, index)=>
                                <div key={index} className='flex items-center gap2 px-3 py-1 rounded-lg bg-[#F5F5FF]/70'>
